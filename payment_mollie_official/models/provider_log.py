...
class ProviderLog(models.Model):
    ...
    """
        ...
        This was initially created by another developer in V10/V11/V12. For backwards compatibility and easier
        migration I've kept the keys identical. Otherwise users who upgrade would need data migration too.
    """
    type = fields.Selection([('red', 'Error'),
                             ('olive', 'Warning'),
                             ('gray', 'Info'),
                             ('green', 'Succes')], string="Type",
