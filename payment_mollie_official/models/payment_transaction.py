...
class PaymentTransaction(models.Model):
    ...
    def _get_mollie_order_line_data(self, order_lines):
        ...
        for line in order_lines:
            currency_name = line.currency_id.name or line.move_id.currency_id.name
            vatRate = 0.0
            ...
            line_data = {
                ...
                'unitPrice': {
                    ...
                    "value": '%.2f' % float(line.price_total / line.quantity)},
                # 'discountAmount': {
                ...
                'vatAmount': {
                    "currency": currency_name,
                    "value": '%.2f' % float(line.price_total - line.price_subtotal)},
    ...
    def _get_mollie_order_data(self, order):
        ...
        method = (self.acquirer_method and
                  self.acquirer_method.acquirer_reference)
    ...
    def mollie_orders_create(self):
        ...
        if self.invoice_ids:
            ...
            order = self.invoice_ids.search([("name", "=", self.reference.split("-")[0])], limit=1)
