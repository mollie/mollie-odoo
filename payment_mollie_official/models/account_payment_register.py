...
class AccountPaymentRegister(models.TransientModel):
    ...
    def action_create_payments(self):
        ...
        if len(self) == 1 and self.is_mollie_refund:
            ...
            payment_data = self.mollie_transecion_id.sudo().acquirer_id._api_mollie_get_payment_data(self.mollie_transecion_id.acquirer_reference, force_payment=True)
            refund = self.mollie_transecion_id.sudo().acquirer_id._api_mollie_refund(self.amount, self.currency_id.name, payment_data.get('id'))
