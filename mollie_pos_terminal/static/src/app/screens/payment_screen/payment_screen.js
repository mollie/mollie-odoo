...
patch(PaymentScreen.prototype, {
    ...
    async addNewPaymentLine(paymentMethod) {
        ...
        if (this.currentOrder.remainingDue >= 0 || paymentMethod.use_payment_terminal != 'mollie' || refundOrderId == false) {
            ...
            this.env.services.dialog.add(AlertDialog, {
                ...
                body: markup(`
                    ...
                    <img style="max-width: 120px;" src="/mollie_pos_terminal/static/src/img/warning.svg" class="img img-fluid mb-2"/>
                        ...
                        <b class="text-warning"> ${ this.env.utils.formatCurrency(-this.currentOrder.remainingDue) } </b> <b class="text-muted small mt-1"> Maximum possible amount for refund is </b>
            ...
            this.dialog.add(ConfirmationDialog, {
                ...
                body: markup(`
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h1 class="mb-0" style="font-size: clamp(24px, 2vw, 64px);"> <b>${this.env.utils.formatCurrency(this.currentOrder.remainingDue)}</b></h1>
