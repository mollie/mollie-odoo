...
class DrPosMakePayment(models.TransientModel):
    ...
    use_payment_terminal = fields.Selection(related='payment_method_id.use_payment_terminal', store=True)
    ...
    def _compute_mollie_transaction_id(self):
        ...
        for wizard in self:
            ...
            if not refund_order or not refund_order.refunded_order_ids:
                continue

            order = refund_order.refunded_order_ids[0]
